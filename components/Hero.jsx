  ...
  return (
    <div className=' text-center '> 
      <div className=' flex justify-center items-center '>
       ...
       <div className=' text-4xl font-medium lg:text-6xl lg:ml-[24rem] '> Choose Your </div> 
       <h1 className=' text-4xl font-medium mt-8 mr-[4.6rem] md:mr-[7rem] lg:text-6xl lg:ml-[17rem] '>Best</h1>
       <h1 className=' text-4xl font-medium mt-4 ml-5  md:mr-[5rem] lg:text-6xl lg:ml-[21rem] '>Teacher</h1>
       </div>
         <div style={gradientStyle} className=' relative mt-[6rem] rotate-6 font-medium  px-4 py-3 rounded-lg  right-[3rem] text-5xl md:right-[15rem] md:top-10 lg:right-[56rem] '>Yoga</div>
      </div>
      <div className='homestar mt-3 relative md:ml-[20rem] lg:ml-[38rem]  '>
       ...
       <p className=' p-2 text-xl relative bottom-[5rem] text-[#4B3E65]  items-center md:w-[40%] md:ml-16 md:-top-10 lg:w-[32%] lg:ml-[16rem] '>Calm your mind and body with the best yoga teachers available, relax your day and stay positive.</p>
       ...
       <div>
       <button style={gradientStyle} className=' text-[#4B3E65] relative bottom-16   py-5 px-16 rounded-[34px] text-2xl md:text-xl md:right-[12rem]   md:py-5 md:px-12 lg:mr-[20rem]   '>Get Started Free</button>
       <div>
       ...
       <div className=' relative ml-[12rem] bottom-[4rem] text-[#220953] md:-ml-[12rem] lg:mr-[20rem] '> <h1 className=' relative text-4xl '>40+</h1>
        <p className=' text-lg text-[#220953]'>Participants</p></div>

        <div className=' relative bottom-[7.9rem] md:ml-[-22rem] mr-[10rem] lg:mr-[32rem] text-[#220953]'><h1 className=' text-4xl  '>300+</h1>
