  ...
  return (
    <div className=' text-center '> 
      <div className=' flex justify-center items-center '>
       ...
       <div className=' text-4xl font-medium '> Choose Your </div> 
       <h1 className=' text-4xl font-medium mt-8 mr-[4.6rem] md:mr-[7rem] '>Best</h1>
       <h1 className=' text-4xl font-medium mt-4 ml-5  md:mr-[5rem] '>Teacher</h1>
       </div>
         <div style={gradientStyle} className=' relative mt-[6rem] rotate-6 font-medium  px-4 py-3 rounded-lg  right-[3rem] text-5xl md:right-[15rem] md:top-10 lg:right-[50.5rem] '>Yoga</div>
      </div>
      <div className='homestar mt-3 relative md:ml-[20rem] lg:ml-[29rem] '>
       ...
       <div>
       <button style={gradientStyle} className=' text-[#4B3E65] relative bottom-16   py-5 px-16 rounded-[34px] text-2xl md:text-xl md:right-[12rem]   md:py-5 md:px-12 lg:mr-[35rem]   '>Get Started Free</button>
       <div>
       <Image className=' ml-[18rem] relative  bottom-[6.6rem] md:ml-[18.8rem] lg:ml-[22.8  rem] ' src={arrowrightline} alt='daylight' height={80} width={20}/> 
       </div>
       </div>
       <div className=' items-center '>
       <div className=' relative ml-[12rem] bottom-[4rem] text-[#220953] md:-ml-[12rem]  '> <h1 className=' relative text-4xl '>40+</h1>
        <p className=' text-lg text-[#220953]'>Participants</p></div>

        <div className=' relative bottom-[7.9rem] md:ml-[-22rem] mr-[10rem] text-[#220953]'><h1 className=' text-4xl  '>300+</h1>
        <p className=' text-lg text-[#220953] '>Yoga Class</p></div>
       </div>
       
       <Image className=' ml-[3rem] bottom-20  relative items-center md:bottom-[39rem] md:left-[24rem] lg:ml-[18rem] lg:w-[30%]  ' src={homeyoga} alt='daylight' height={80} width={313}/> 
