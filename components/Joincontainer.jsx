...
export default function Joincontainer() {
  ...
  return (
    <div>
        <div style={gradientStyle} className=' pb-10 rounded-[30px] mx-6 '>
        ...
        <button style={gradientStyle} className='py-5 md:py-3 md:px-2 px-24 rounded-[34px] text-2xl ml-16 mb-16 md:text-lg md:w-[44%]  '>Subscribe</button>
        <Image className=' -mt-28  ml-[17.4rem] relative top-1  md:ml-[11.6rem]  ' src={arrowrightline} alt='daylight' height={80} width={20}/> 
        </div>
        </div>
