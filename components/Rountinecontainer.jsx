  ...
  return (
    <div className=''>
       <div className=' wrapper md:-mt-[20rem]'>
        <div className=' mt-10 '>
        <p className="text-center relative bottom-20 text-[36px] font-semibold p-2 text-[#220953] md:top-[-44rem] md:ml-10 md:w-[39%] lg:text-left lg:w-[20%] lg:ml-[19rem] ">Anytime, Any Place, Any Workout</p>
           <p className="text-[16px] leading-[22px] font-normal text-[#4B3E65] ml-4 relative bottom-12 text-center w-[331px] md:top-[-44rem] md:w-[32%] md:ml-[5.5rem] lg:text-left lg:ml-[19rem] ">Take your routine at any time of your day, with the new videos and with the teachers who will guide you.</p>
           <div className=' relative  right-4 md:top-[-42rem] md:ml-10 lg:ml-[16rem] '>
